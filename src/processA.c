    ...
    while(1){
        ...
        switch(choice){
            ...
            case 2:
                    ...
                    bzero(&serv_addr, sizeof(serv_addr));  //initialise serv_addr
            ...
            case 3:
                    ...
                    serv_addr.sin_family = AF_INET;
                    serv_addr.sin_port = htons(port);
                    serv_addr.sin_addr.s_addr = htonl(INADDR_ANY);//htonl(address);
            ...
            case 4:
                    ...
                    // close all resources when exit is choosen
                    fflush(stdout);
                    unlink(shm_name);
                    close(fd_shm);
                    munmap(ptr,size);
